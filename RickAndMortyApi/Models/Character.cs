...
public class Character
{
    ...
    public CharacterStatus Status { get; set; } //	The status of the character ('Alive', 'Dead' or 'unknown').
    ...
    public CharacterGender Gender { get; set; } //	The gender of the character ('Female', 'Male', 'Genderless' or 'unknown').
    public object Origin { get; set; } //	Name and link to the character's origin location.
    public object Location { get; set; } //	Name and link to the character's last known location endpoint.
